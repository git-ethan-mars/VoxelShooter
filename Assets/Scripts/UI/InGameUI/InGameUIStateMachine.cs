...
namespace UI.InGameUI
{
    public class InGameUIStateMachine
    {
            ...
            IAvatarLoader avatarLoader, Transform parent)
        {
            ...
            {
                [typeof(DefaultState)] =
                    new DefaultState(networkManager, uiFactory.CreateTimeCounter(parent, networkManager)),
                ...
                [typeof(ScoreboardState)] =
                    new ScoreboardState(uiFactory.CreateScoreBoard(parent, networkManager, avatarLoader))
            };
        }
