...
namespace Inventory.Drill
{
    public class DrillState : IInventoryItemState
    {
        ...
        public DrillState(IInventoryInput inventoryInput, RayCaster rayCaster, DrillLauncherItem configure,
            Hud hud, DrillLauncherData rocketLauncherLauncherData)
        {
            _inventoryInput = inventoryInput;
            _drillModel = new DrillModel(rayCaster, rocketLauncherLauncherData);
