...
namespace Inventory.Grenade
{
    public class GrenadeModel : IInventoryItemModel, IConsumable
    {
        ...
        public int Amount
        {
            get => _grenadeData.Amount;
            set
            {
                _grenadeData.Amount = value;
                ModelChanged?.Invoke();
            }
        }
        ...
        private readonly GrenadeData _grenadeData;


        public GrenadeModel(RayCaster rayCaster, GrenadeItem configure, GrenadeData data)
        {
