...
{
    public partial class RequestHandlers
    {
        ...
        public RequestHandlers(IEntityFactory entityFactory, ICoroutineRunner coroutineRunner,
        ...
        private void OnAddBlocks(NetworkConnectionToClient connection, AddBlocksRequest message)
        {
            ...
            connection.Send(new ItemUseResponse(message.ItemId, blockAmount - blocksUsed));
        }
        ...
        private void OnChangeSlot(NetworkConnectionToClient connection, ChangeSlotRequest message)
        {
            ...
            connection.Send(new ChangeSlotResponse(message.Index));
        }
    }
}