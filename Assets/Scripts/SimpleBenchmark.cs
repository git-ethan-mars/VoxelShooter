...
public static class SimpleBenchmark
{
	public static void Execute(Action action)
	{
		...
		action.Invoke();
		stopwatch.Stop();
		Debug.Log($"{action.Method.Name} | {stopwatch.ElapsedMilliseconds} ms");
	}
	...
	public static TResult Execute<TResult>(Func<TResult> function)
	{
		...
		stopwatch.Stop();
		Debug.Log($"{function.Method.Name} | {stopwatch.ElapsedMilliseconds} ms");
		return result;
	}
	...
	{
		var stopwatch = Stopwatch.StartNew();
		TResult result = function.Invoke(argument);
		stopwatch.Stop();
		Debug.Log($"{function.Method.Name} | {stopwatch.ElapsedMilliseconds} ms");
		return result;
	}
	...
	{
		var stopwatch = Stopwatch.StartNew();
		T3 result = function.Invoke(argument1, argument2);
		stopwatch.Stop();
		Debug.Log($"{function.Method.Name} | {stopwatch.ElapsedMilliseconds} ms");
		return result;
	}
