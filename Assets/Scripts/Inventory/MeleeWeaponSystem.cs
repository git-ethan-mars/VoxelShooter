...
namespace Inventory
{
    public class MeleeWeaponSystem : IInventoryItemView, ILeftMouseButtonDownHandler, ILeftMouseButtonHoldHandler, IUpdated
    { 
        ...
        public MeleeWeaponSystem(IGameFactory gameFactory, IInputService inputService, Camera camera,
